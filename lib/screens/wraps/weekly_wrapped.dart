...
class WeeklyWrapped extends StatefulWidget {
  const WeeklyWrapped({super.key});

  @override
  _WrappedStoryState createState() => _WrappedStoryState();
}

class _WrappedStoryState extends State<WeeklyWrapped>
  ...
  final List<Map<String, dynamic>> wrappedSlides = [
    ...
    {
      "title": "Your End of Week Wrapped!",
